...
Set the `output_format` argument of `render` to render your .Rmd file into any of R Markdown’s supported formats. For example, the code below renders 1-example.Rmd to a Microsoft Word document. You can try it out [here](https://posit.cloud/content/181952?_gl=1*1w7428q*_ga*OTgwMTA4NTc5LjE3NDQ3MzQ3Mzg.*_ga_2C0WZ1JHG0*MTc0NDczNDczNy4xLjEuMTc0NDczNzEwNS4wLjAuMA..) on RStudio Cloud.
...
Each output format is implemented as a function in R. You can customize the output by passing arguments to the function as sub-values of the `output` field. For example, [8-outputs.Rmd](https://posit.cloud/content/181952) would render with a floating table of contents.

![](https://d33wubrfki0l68.cloudfront.net/679772c08cd0b359c8632269e19820b320a785f4/1f976/lesson-images/outputs-3-toc.png)
