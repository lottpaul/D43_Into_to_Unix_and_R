...
<img src="../_resources/54eeccb4a36f56955a882254cebe1ae6.png" alt="54eeccb4a36f56955a882254cebe1ae6.png" width="551" height="534" class="jop-noMdConv">
...
<img src="../_resources/fc7d8460f6e3414196c9be84122a879a.png" alt="fc7d8460f6e3414196c9be84122a879a.png" width="900" height="453" class="jop-noMdConv">  
...
| OS      | Native UNIX/Linux | Terminal Program |
| ------- | ----------------- | ---------------- |
| Mac OSX | Darwin BSD        | Terminal         |
| Linux   | Linux             | Terminal         |
| Windows | None (WSL2)       | Windows Terminal |
...
An alternative to Windows lack of Linux support, is Windows Subsystem for Linux 2 (WSL2) - it runs a Linux container that is optimized for Windows.  The 

* * *
# Unix Cheatsheet
**Unix/Linux Commands Cheatsheets:**

- [**English**](https://files.fosswire.com/2007/08/fwunixref.pdf)
