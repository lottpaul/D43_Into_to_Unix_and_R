...
<img src="../_resources/abddc3f0077f648a9b794a5857982811.png" alt="abddc3f0077f648a9b794a5857982811.png" width="554" height="415" class="jop-noMdConv">

Then moving down the tree, we see there are 6 *directories* accessible from the `/` , (etc, usr, bin, home, lib, var).

Note:  `tree` is a unix command that will show you the directory structure within you current terminal windows.
...
## Important Notes about your Home Directory
On HIVE, your home directory is limited to 20GB.  If you reach the limit, you'll recieve an error message and further commands may fail to run.
...
### Note about `\` backslash  - Common Point of Confusion
In Unix a backslash is used to indicate that you're going to continue entering a command on the next line.    In Windows, a back slash is used in place of the forward slash in Unix.    
